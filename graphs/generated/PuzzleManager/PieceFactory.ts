...
export class PieceFactory extends ethereum.SmartContract {
  static bind(address: Address): PieceFactory {
    return new PieceFactory("PieceFactory", address);
  }

  IPFS_TOKEN_BASE_URI(): string {
  ...
  try_IPFS_TOKEN_BASE_URI(): ethereum.CallResult<string> {
  ...
  tokenURIWithoutPrefix(tokenId: BigInt): string {
    let result = super.call(
      "tokenURIWithoutPrefix",
      "tokenURIWithoutPrefix(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    );
  ...
  try_tokenURIWithoutPrefix(tokenId: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "tokenURIWithoutPrefix",
      "tokenURIWithoutPrefix(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
...
export class UpdateManagerCall__Inputs {
  ...
  get newManagerContract(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}
